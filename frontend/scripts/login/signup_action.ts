...
const SignUperror = document.getElementById('error') as HTMLParagraphElement;
...
SignUpform.addEventListener('submit', (event) => 
{
	...
	const username = (document
		.getElementById('new_user') as HTMLInputElement).value;
	const password = (document
		.getElementById('new_pass') as HTMLInputElement).value;
	const repeat_password = (document
		.getElementById('new_pass2') as HTMLInputElement).value;
