...
import { SESSION_ID_COOKIE_NAME, routeCheckUserSession, routeClearCookie, routeMakeNewCookie, validateSession } from "./cookie";
...
export async function registerRoutes(fastify: FastifyInstance)
{
    ...
    fastify.get('/api/user/session', routeCheckUserSession);
